...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section - White/Light with Blue accents */}
      <section className="bg-gradient-to-b from-blue-50 to-white py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 tracking-tight leading-tight mb-4">
            TrustTrade
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              className="text-lg px-8 py-6 border-blue-300 text-blue-600 hover:bg-blue-50"
            >
              How It Works
            </Button>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of South Africans who trust TrustTrade for secure transactions.
          </p>
          <Button
            onClick={handleLogin}
            size="lg"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="mailto:support@trusttradesa.co.za" className="text-slate-500 hover:text-blue-600 text-sm">support@trusttradesa.co.za</a></li>
              </ul>
            </div>
          </div>
