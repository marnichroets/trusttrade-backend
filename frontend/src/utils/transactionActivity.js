...
function eventCopy(type, role, transaction) {
  ...
  const copy = {
    ...
    buyer_joined: {
      ...
      detail: 'Both parties can now review the deal.',
      tone: 'blue',
      icon: 'user',
    },
    escrow_funded: {
      title: role === 'buyer' ? 'You secured the payment' : role === 'seller' ? 'Buyer secured the payment' : 'Payment secured',
    ...
    seller_dispatched: {
      ...
      detail: 'Delivery is in progress and your payment is protected.',
      tone: 'blue',
      icon: 'truck',
    },
    buyer_confirmed: {
      title: role === 'buyer' ? 'You confirmed delivery' : 'Buyer confirmed delivery',
      detail: 'Release conditions were met and payout is on its way.',
      tone: 'green',
      icon: 'check',
    },
    funds_released: {
      title: 'Payment released',
      detail: role === 'seller' ? 'Your payout is now moving through the banking system.' : 'Payment release is complete.',
      tone: 'green',
      icon: 'banknote',
    },
    payout_processing: {
      title: role === 'seller' ? 'Your payout is processing' : 'Payout processing',
      detail: 'Your payment has been released and is moving through the banking system.',
      tone: 'amber',
      icon: 'activity',
    },
    payout_completed: {
